...
Zelthir currently contains the `Grounded` hackathon MVP: a news intelligence prototype that groups overlapping reporting, builds a cleaner front page, and ships with a docs-style PRD viewer.
...
![Grounded homepage](docs/screenshots/grounded-homepage.png)

### PRD Viewer

![Grounded PRD viewer](docs/screenshots/prd-viewer.png)
...
- `/app/`: the live Grounded homepage with grouped coverage, tabs, relevance controls, and analysis panels.
...
- Stage: Hackathon MVP
- Owner in spec: Team Grounded
- Package name: `grounded-news-prototype`
