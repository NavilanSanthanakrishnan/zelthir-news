...
Grounded is an AI news intelligence platform with one shared intelligence engine and two user-facing surfaces:
...
Grounded turns fragmented news coverage into a best-supported account of events, shows what claims are agreed or disputed, connects stories to related actors and prior events, and forecasts what may happen next.
...
2. User asks a grounded question.
...
- generate grounded summaries and forecast blocks
...
- write concise grounded story brief
...
### `POST /story/:id/ask`
- grounded Q&A over story cluster
...
| Brief | strong evidence set | grounded brief generated |
...
| Story Q&A | user asks grounded question | answer cites only story evidence |
...
Grounded is a personalized AI news intelligence platform with two modes:
