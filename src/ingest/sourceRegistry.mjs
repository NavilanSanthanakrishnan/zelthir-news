...
export const US_NATIONAL_RSS_SOURCES = [
  ...
  usSource({
    ...
    siteUrl: "https://rollcall.com",
    allowedHosts: ["rollcall.com"],
    priority: 74,
    required: true,
  }),
  usSource({
...
export const US_LOCAL_RSS_SOURCES = [
  ...
  usSource({
    id: "ohio-capital-journal",
    name: "Ohio Capital Journal",
    scope: "state",
    state: "OH",
    categories: ["politics", "education", "health", "energy"],
    feedUrl: "https://ohiocapitaljournal.com/feed/",
    siteUrl: "https://ohiocapitaljournal.com",
    allowedHosts: ["ohiocapitaljournal.com"],
    priority: 76,
    required: true,
  }),
  usSource({
    ...
    siteUrl: "https://www.cleveland.com",
    allowedHosts: ["cleveland.com"],
    priority: 72,
    required: true,
  }),
  usSource({
    ...
    scope: "state",
    state: "MI",
    categories: ["politics", "education", "health", "labor"],
    feedUrl: "https://michiganadvance.com/feed/",
    siteUrl: "https://michiganadvance.com",
    allowedHosts: ["michiganadvance.com"],
    priority: 76,
    required: true,
  }),
  usSource({
    ...
    city: "Detroit",
    metro: "Detroit",
    categories: ["general", "politics", "education", "housing"],
    feedUrl: "https://www.bridgedetroit.com/feed/",
    siteUrl: "https://www.bridgedetroit.com",
    allowedHosts: ["bridgedetroit.com"],
    priority: 72,
    required: true,
  }),
  usSource({
    ...
    scope: "state",
    state: "NC",
    categories: ["politics", "education", "health", "climate"],
    feedUrl: "https://ncnewsline.com/feed/",
    siteUrl: "https://ncnewsline.com",
    allowedHosts: ["ncnewsline.com"],
    priority: 76,
    required: true,
  }),
  usSource({
    ...
    state: "VA",
    categories: ["politics", "education", "health", "energy"],
    feedUrl: "https://virginiamercury.com/feed/",
    siteUrl: "https://virginiamercury.com",
    allowedHosts: ["virginiamercury.com"],
    priority: 76,
    required: true,
  }),
  usSource({
    id: "new-jersey-monitor",
    name: "New Jersey Monitor",
    scope: "state",
    state: "NJ",
    categories: ["politics", "education", "health", "climate"],
    feedUrl: "https://newjerseymonitor.com/feed/",
    siteUrl: "https://newjerseymonitor.com",
    allowedHosts: ["newjerseymonitor.com"],
    priority: 76,
    required: true,
  }),
  usSource({
    ...
    scope: "state",
    state: "MN",
    categories: ["politics", "education", "health", "culture"],
    feedUrl: "https://www.minnpost.com/feed/",
    siteUrl: "https://www.minnpost.com",
    allowedHosts: ["minnpost.com"],
    priority: 74,
    required: true,
  }),
  usSource({
    id: "oregon-capital-chronicle",
    name: "Oregon Capital Chronicle",
    scope: "state",
    state: "OR",
    categories: ["politics", "education", "health", "climate"],
    feedUrl: "https://oregoncapitalchronicle.com/feed/",
    siteUrl: "https://oregoncapitalchronicle.com",
    allowedHosts: ["oregoncapitalchronicle.com"],
    priority: 76,
    required: true,
  }),
];
...
export const US_LOCAL_SOURCE_CANDIDATES = [
  ...
  usSource({
    ...
    candidateFeedUrl: "https://floridapolitics.com/feed/",
    candidateReason: "Feed repeatedly timed out during active source verification.",
  }),
  usSource({
    id: "miamiherald",
    name: "Miami Herald",
